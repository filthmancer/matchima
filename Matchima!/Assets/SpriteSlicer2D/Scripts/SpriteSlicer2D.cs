...
public static class SpriteSlicer2D 
{
	...
	public static Color s_overrideColor = Color.white;
	...
	public static void ShatterSprite(GameObject spriteObject, float explosionForce, bool destroySlicedObjects, ref List<SpriteSlicer2DSliceInfo> slicedObjectInfo)
	{
		...
		if(polygonPoints != null && polygonPoints.Count > 3)
		{
			...
			for(int loop = 0; loop < triangles.Length; loop += 3)
			{
				...
				childSprite.GetComponent<Renderer>().material.color = s_overrideColor;
...
public class SlicedSprite : MonoBehaviour
{
	...
	void InitSprite(GameObject parentObject, Renderer parentRenderer, ref PolygonCollider2D polygon, ref Vector2[] polygonPoints, Vector3 minCoords, Vector3 maxCoords, Bounds spriteBounds, Material material, bool rotated, bool hFlipped, bool vFlipped, Vector2 parentCentroid, Vector2 uvOffset, bool isConcave)
    {
        ...
        m_MeshRenderer.material.color = SpriteSlicer2D.s_overrideColor;
