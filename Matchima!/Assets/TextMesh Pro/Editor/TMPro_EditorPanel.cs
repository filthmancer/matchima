...
namespace TMPro.EditorUtilities
{
    ...
    public class TMPro_EditorPanel : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m_foldout.fontSettings)
            {
                ...
                if (EditorGUI.EndChangeCheck())
                {
                    ...
                    m_targetMaterial = fontAsset.material;
                    GetMaterialPresets();
                ...
                if (EditorGUI.EndChangeCheck())
                {
                    ...
                    //m_targetMaterial = m_textComponent.fontSharedMaterial = fontSharedMaterial_prop.objectReferenceValue as Material;

                    havePropertiesChanged = true;
                }

                // Make sure material preset selection index matches the selection
                if (m_targetMaterial != m_materialPresets[m_materialPresetSelectionIndex])
                {
        ...
        /// </summary>
        private void GetMaterialPresets()
        {
            TMP_FontAsset fontAsset = fontAsset_prop.objectReferenceValue as TMP_FontAsset;
