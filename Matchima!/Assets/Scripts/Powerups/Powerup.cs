...
public class Powerup : MonoBehaviour {
	...
	public IEnumerator PowerupStartup()
	{
		...
		MiniAlertUI b = UIManager.instance.MiniAlert(UIManager.Objects.MiddleGear.transform.position + Vector3.up * 2.0F, Name, 200, GameData.Colour(Parent.Genus), step_time, 0.2F);
