...
public class Rally : Ability {
	...
	IEnumerator RallyRoutine()
	{
		...
		UIManager.instance.MiniAlert(UIManager.ClassButtons[Parent.Index].transform.position + Vector3.up*0.6F, "Rally!", 34, GameData.Colour(Parent.Genus), 0.8F, 0.1F, true);
